  ...
  const projectData = {
    roxana: {
      ...
      slides: [
        ...
        { title: 'Checkout vía WhatsApp', desc: 'Pantalla de finalización con selección de tipo de entrega (retiro en local o envío privado), notas del pedido y botón de WhatsApp que envía el resumen completo al negocio. Captura en modo oscuro.', icon: 'cart', image: 'images/projects/roxana-checkout.png' },
